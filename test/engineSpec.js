...
=======
        var hmdaJson = {};
        var topLevelObj = {};
        var resolveArg = require('../lib/utils').resolveArg;
        ...
        it('should return a value for an existing property in topLevelObj', function(done) {
            var contextList = [topLevelObj, hmdaJson.hmdaFile];
>>>>>>> Move some of the private functions to a utils, use properties for managed state in engine
...
=======
        var hmdaJson = {};
        var topLevelObj = {};
        var retrieveProps = require('../lib/utils').retrieveProps;
...
=======
        var hmdaJson = {};
        var topLevelObj = {};
        var handleArrayErrors = require('../lib/utils').handleArrayErrors;
...
=======
        var hmdaJson = {};
        var topLevelObj = {};
        var handleUniqueLoanNumberErrors = require('../lib/utils').handleUniqueLoanNumberErrors;
