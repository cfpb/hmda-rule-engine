...
var RuleParseAndExec = (function() {
    return function() {
        ...
        this.getExecRulePromiseLar = function(args, editResults) {
            return this.execParsedRule(args.topLevelObj, args.functionBody, args.result)
            .then(function(result) {
                if (_.isArray(result) && result.length !== 0) {
                    utils.addToErrors.apply(editResults, [result, args.rule, args.editType, args.scope]);
                }
            });
        };
        ...
        this.runEditsLar = function(year, editType, lar, editResults) {
            ...
            return Promise.map(rules, function(currentRule) {
                ...
                return this.getExecRulePromiseLar(args, editResults);
        ...
        this.getEditRunPromiseLar = function(year, type, lar, editResults) {
            this.setRuleYear(year);
            return this.runEditsLar(year, type, lar, editResults);
        };
