...
/**
 * Construct a new CSVProcessor and return its csv transformer
 ...
 * @param {string} type         Processor type. Valid values: 'all', 'individual'
...
CSVProcessor.prototype.all = function() {
    this.transformer = errorsTransformerAll.apply(this);
};
